...
function createScene() {
    ...
    groundGeometry.worldMatrix.makeTranslation(0, -1, -10).multiply(new Matrix4().makeScale(10, 10, 10));
    ...
    sphereGeometry.worldMatrix.makeTranslation(0, 0, -5).multiply(new Matrix4().makeScale(.01, .01, .01));
}
